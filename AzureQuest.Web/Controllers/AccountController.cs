...
using AzureQuest.Web.Models.AccountViewModels;
...
namespace AzureQuest.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task LogInAuth0(string returnUrl = "/")
        {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task LogoutAuth0(string returnUrl = "/")
        {
            ...
            string postLogoutUri = $"{request.Scheme}://{request.Host}{request.PathBase}";

            // Redirect to the Auth0 logout endpoint in order to log out of Auth0
            string logoutUri = $"https://{_auth0Settings.Domain}/v2/logout?client_id={_auth0Settings.ClientId}&returnTo={Uri.EscapeDataString(postLogoutUri)}";
        ...
        public async Task<IActionResult> Login(string returnUrl = null)
        {
            ...
            if (_auth0Settings?.Enabled == true) { return Redirect("/account/LogInAuth0"); }
        ...
        {
            if (_auth0Settings.Enabled) { return Redirect("/account/LogoutAuth0"); }
